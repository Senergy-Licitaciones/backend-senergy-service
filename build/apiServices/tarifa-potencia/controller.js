...
const tarifa_potencia_1 = require("../../services/tarifa-potencia");
const exportFile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { _id } = req.admin;
        const { fechaInicio, fechaFin } = req.body;
        const response = yield (0, tarifa_potencia_1.exportFileTarifa)({ fechaInicio, fechaFin, id: _id });
...
const deleteTarifas = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield (0, tarifa_potencia_1.deleteTarifasService)();
        return res.status(200).send(response);
    }
    catch (e) {
        return (0, handleError_1.httpError)(res, e);
...
const exportFileToUpdate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { _id } = req.admin;
        const response = yield (0, tarifa_potencia_1.exportFileToUpdateService)({ id: _id });
        return res.status(200).send(response);
    }
    catch (e) {
        return (0, handleError_1.httpError)(res, e);
...
const addTarifas = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield (0, tarifa_potencia_1.addTarifasService)({ filename: path });
        return res.status(200).send(response);
    }
    catch (err) {
        return (0, handleError_1.httpError)(res, err);
...
const updateTarifas = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (file == null)
            return res.status(400).send({ message: 'No se ha subido ningún archivo' });
        const path = `uploads/files/admin/${file.filename}`;
        const response = yield (0, tarifa_potencia_1.updateTarifasService)({ path });
...
const updateTarifa = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield (0, tarifa_potencia_1.updateTarifaService)({ id: idTarifa, valor: value, fecha });
        return res.status(200).send(response);
    }
    catch (e) {
        return (0, handleError_1.httpError)(res, e);
...
const getTarifas = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tarifas = yield (0, tarifa_potencia_1.getTarifasService)();
