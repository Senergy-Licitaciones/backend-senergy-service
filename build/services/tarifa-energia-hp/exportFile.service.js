...
const exportFileTarifa = ({ fechaInicio, fechaFin, id }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, excel_1.addWorksheetToBook)(workbook, worksheet, 'Base de datos Tarifa Energía HP');
        const path = `uploads/files/admin/tarifas-energia-hp-${id}.xlsx`;
        (0, excel_1.createFile)(workbook, path);
        return {
            message: 'Se ha exportado el archivo exitosamente',
            filename: `tarifas-energia-hp-${id}.xlsx`
        };
    }
    catch (e) {
...
const exportFileToUpdateService = ({ id }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tarifas = yield (0, tarifa_energia_hp_1.getTarifasDao)();
