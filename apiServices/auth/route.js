...
const {loginAdmin,logoutProveedor, registerProveedor,confirmProveedorAccount, registerUsuario, loginProveedor,logoutUsuario,confirmAccount, loginUsuario } = require("./controller");
...
router.put("/logoutUsuario",checkAuth,checkUserType(["user"]),checkRoleAuth(["basico","premium","admin"]),logoutUsuario);
router.put("/logoutProveedor",checkAuth,checkUserType([`proveedor`]),checkRoleAuth([`basico`,"premium","admin"]),logoutProveedor);
